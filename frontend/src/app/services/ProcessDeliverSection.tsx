...
const STEPS = [
  {
    ...
    body: "Deep dive into your goals and operational context to craft a precision blueprint tailored to your enterprise.",
    tone: "navy" as const,
  ...
  },
  {
    ...
    body: "Complete architecture, immersive wireframing, and strategic UX planning mapping your future workflow seamlessly.",
  ...
  },
  {
    ...
    body: "Rigorous, scalable agile builds backed by automated QA testing matrices and dedicated engineering sprints.",
    tone: "navy" as const,
  ...
  },
  {
    ...
    body: "Flawless go-live execution followed by dedicated round-the-clock maintenance and SLA commitments.",
    tone: "orange" as const,
